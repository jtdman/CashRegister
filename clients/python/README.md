...
Python command-line client for processing cash register transactions via the REST API.
...
python cash_register.py ../../data/sample-eur.txt
```
...
# Enable half dollars
python cash_register.py ../../data/sample-usd.txt --half-dollars

# Custom API URL
python cash_register.py ../../data/sample-usd.txt --api http://localhost:8080

# Custom output path
python cash_register.py ../../data/sample-usd.txt -o ./my-output.txt

# Using environment variable
CASH_REGISTER_API=http://localhost:8080 python cash_register.py ../../data/sample-usd.txt
```

## Output

Results are written to `../../output/clients/python/<input-filename>-output.txt` and also printed to stdout.
